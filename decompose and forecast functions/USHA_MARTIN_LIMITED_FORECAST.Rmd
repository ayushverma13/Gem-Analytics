---
title: "USHA_MARTIN_LIMITED_Forecast"
...
source("~/Desktop/decompose and forecast functions/forecast_customers.R")

a <- forecast_customers(master,1,4,1)
a$temp2
kable(a$temp1)
```
...
source("~/Desktop/decompose and forecast functions/forecast_customers.R")
# 
a<-forecast_customers(master_ltr,2,4,1)
a$temp2
kable(a$temp1)
```
...
# 
a<-forecast_customers(master_ltr,2,3,1)
a$temp2
kable(a$temp1)
```
