forecast_totalsales<-function(x,measure,horizontype){
   #measure is to choose between value and volume
  ...
  if(measure == 1){
    ...
    if(horizontype==1){
      ...
      temp$temp2<-dygraph(df_final, main = paste("total sales by value "))%>%
    ...
    if(measure == 2)
  {
    ...
    if(horizontype==1){
      ...
      temp$temp2<-dygraph(df_final, main = paste("total sales by volume "))%>%
