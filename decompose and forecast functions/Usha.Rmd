---
title: "Usha Martin HSPR Top Products(Value) - Decomposition and Forecasts"
...
# Decomposition and Forecasts of Top product sales by value

# Spring Wire Grade-I
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
source("~/Desktop/decompose and forecast functions/decompose_products.R")
a<-decompose_products(umar_total_territory,5,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
source("~/Desktop/decompose and forecast functions/forecast_products.R")
a<-forecast_product(umar_total_territory,1,5,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,5,2)
a[[2]]
kable(a[[1]])
```
...
# Spring Wire Grade-II
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,2,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,2,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,2,2)
a[[2]]
kable(a[[1]])
```
...
# Spring Wire Grade-II(BORAX)

``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,28,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,28,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,28,2)
a[[2]]
kable(a[[1]])
```


# Spring Wire Grade-III
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,6,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,6,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,6,2)
a[[2]]
kable(a[[1]])
```
...
# Spring Wire FQ
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,4,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,4,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,4,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,1,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,1,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,1,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,3,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,3,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,3,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,7,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,7,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,7,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,9,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,9,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,9,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,11,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,11,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,11,2)
a[[2]]
kable(a[[1]])
```
...
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-decompose_products(umar_total_territory,20,1)
a[[1]]
a[[2]]
a[[3]]
...
#Monthly
``` {r echo =FALSE, results = 'asis', warning=FALSE, results='show'}
a<-forecast_product(umar_total_territory,1,20,1)
a[[2]]
kable(a[[1]])
...
a<-forecast_product(umar_total_territory,1,20,2)
a[[2]]
kable(a[[1]])
```
